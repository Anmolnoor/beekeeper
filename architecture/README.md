# Beehive Agent Platform — Architecture Index

This folder documents the full architecture of the **Beehive Agent Platform**, a production-grade multi-agent system built in Python.
...
| [03_core_modules.md](./03_core_modules.md) | Deep-dive into every Python module in `beehive/` |
...
```
beehive/          ← Core agent runtime (Queen, Workers, Honeycomb, etc.)
